...
const CalendarWithAttendance = ({ presentDates, absentDates, halfDayDates, notMarkedDates }) => {
  ...
  function tileContent({ date, view }) {
    ...
    switch (status) {
      case "present":
        return <div className="present-marker"><CheckCircleOutlineOutlined /></div>;
      case "absent":
        return <div className="absent-marker"><CancelOutlined /></div>;
      case "halfDay":
        return <div><RemoveCircleOutline /></div>;
      case "futureDate":
        return <div style={{ color: "gray" }}><RemoveOutlined /></div>;
      default:
        return null;
    }
  }
